...
_find_package(Cairo 1.14.0 REQUIRED)
_find_package(Fontconfig 2.8.0 REQUIRED)
_find_package(Freetype 2.4.2 REQUIRED)
_find_package(GLIB 2.44.0 REQUIRED COMPONENTS gio gio-unix gobject gthread gmodule)
_find_package(HarfBuzz 0.9.18 REQUIRED COMPONENTS ICU)
_find_package(ICU 60.2 REQUIRED COMPONENTS data i18n uc)
_find_package(JPEG REQUIRED)
_find_package(LibEpoxy 1.4.0 REQUIRED)
_find_package(LibGcrypt 1.6.0 REQUIRED)
_find_package(LibSoup 2.54.0 REQUIRED)
_find_package(LibXml2 2.8.0 REQUIRED)
_find_package(PNG REQUIRED)
_find_package(SQLite3 REQUIRED)
_find_package(Threads REQUIRED)
_find_package(WebP REQUIRED COMPONENTS demux)
_find_package(WPE REQUIRED)
_find_package(ZLIB REQUIRED)

# Add stubs before find_package
...
add_stublib(ICU::i18n ${ICU_INCLUDE_DIRS})
add_stublib(ICU::uc ${ICU_INCLUDE_DIRS})
add_stublib(LibXml2::LibXml2 ${LIBXML2_INCLUDE_DIRS})
add_stublib(ZLIB::ZLIB ${ZLIB_INCLUDE_DIRS})
# Not mentioned in WebKitFindPackage.cmake
add_stublib(SQLite::SQLite3 ${SQLite3_INCLUDE_DIRS})
add_stublib(Cairo::Cairo ${Cairo_INCLUDE_DIRS})
add_stublib(Fontconfig::Fontconfig ${Fontconfig_INCLUDE_DIRS})
add_stublib(Freetype::Freetype ${FREETYPE_INCLUDE_DIRS})
add_stublib(HarfBuzz::HarfBuzz ${HarfBuzz_INCLUDE_DIRS})
add_stublib(HarfBuzz::ICU ${HarfBuzz_INCLUDE_DIRS})
add_stublib(PNG::PNG ${PNG_INCLUDE_DIRS})
add_stublib(WebP::demux ${WebP_INCLUDE_DIRS})
add_stublib(WebP::libwebp ${WebP_INCLUDE_DIRS})
add_stublib(WPE::libwpe ${WPE_INCLUDE_DIRS})
add_stublib(JPEG::JPEG ${JPEG_INCLUDE_DIRS})
